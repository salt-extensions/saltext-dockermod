...
addtl_paths = (
    os.path.join(os.pardir, "src"),  # saltext.dockermod itself (for autodoc)
...
dist = distribution("saltext.dockermod")
...
linkcheck_ignore = [
    r"http://localhost:\d+",
    r"https://docs.docker.com\/reference\/api\/engine\/version\/v1.33\/#tag.*",
]
